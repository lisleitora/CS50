...
-- The collection name is created by the user as a way of personalising it, for example, 'chunkybanner56 favorite harry potter fanfics'.
    "name" TEXT NOT NULL,
-- The ids of the author(s) and cotribuitors of the collection, in other words, who can add and take the works from the collection
    "contribuitors_ids" INTEGER NOT NULL,
-- The  works the collection has.
    "bookmarks_id" INTEGER NOT NULL,
-- The date when the collection was created.
    "creation_date" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
-- The last time it was updated
    "updated_at" NUMERIC DEFAULT CURRENT_TIMESTAMP,
FOREIGN KEY("bookmarks_id") REFERENCES "bookmarked"("id"),
FOREIGN KEY("contribuitors_ids") REFERENCES "collection_contribuitors_connect"("contribuitor_id")
);
